...
# This will search for image files (e.g., .jpg, .png) in each subdirectory
test_images = glob.glob("/home/ayaks69/Documents/final_proj_cc_lab/data/test/*/*")  # This will include images inside subdirectories
for img in test_images:
    if os.path.isfile(img):  # Ensure that only files are processed, not directories
